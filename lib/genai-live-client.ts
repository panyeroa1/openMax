...
// FIX: Refactored to use composition over inheritance for EventEmitter to avoid compilation errors regarding 'emit'
export class GenAILiveClient {
  ...
  // FIX: Use an internal EventEmitter instance for composition
  private emitter = new EventEmitter<LiveClientEventTypes>();

  // FIX: Expose on/off/once methods from the internal emitter
