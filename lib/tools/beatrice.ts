...
export const beatriceTools: FunctionCall[] = [
    ...
    {
        name: 'manage_beatrice',
        description: 'Controls the Beatrice service and configuration (v2026.2.2-3).',
        parameters: {
            type: 'OBJECT',
            properties: {
                action: {
                    ...
                    description: 'The Beatrice action to perform.'
                },
                params: {
                    type: 'STRING',
    ...
    },
    {
        ...
        description: 'Manages the Beatrice GitHub repository on the host.',
        parameters: {
            type: 'OBJECT',
            properties: {
                command: {
    ...
    {
        name: 'report_to_milord',
        description: 'Sends a silent status update message to Milord (User) during background tasks or multi-step operations. Use this to report progress without interrupting the flow.',
        parameters: {
            type: 'OBJECT',
            properties: {
                message: {
